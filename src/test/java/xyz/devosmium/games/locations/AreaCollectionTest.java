...
/**
 * The AreaCollectionTest confirms the collection is able to be created, stored,
 * and retrieved.
 */
public class AreaCollectionTest extends AreaCollection {
  ...
  /**
   * Test Case: An Area should be able to be located by name if it exists in
   * AreaCollection Test Case: null should be returned if Area is not found by
   * name in AreaCollection
   */
  @Test
  public void searchAreaName() {
    assertEquals("Test Area",
                 areas.searchAreaByName("Test Area").getAreaName());
    assertEquals(null, areas.searchAreaByName("Test Area Not Found"));
  }

  /**
   * Test Case: An Area should be able to be located by ID if it exists in
   * AreaCollection Test Case: null should be returned if Area is not found by
   * ID in AreaCollection
   */
  @Test
